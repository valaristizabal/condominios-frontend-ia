          ...
          <form className="space-y-7" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              <div className="mb-2.5 flex items-center justify-between">
                <label
                  htmlFor="password"
                  className="block text-[1.25rem] font-bold text-slate-700"
                >
                  Password
                </label>
                <a
            ...
            <label className="inline-flex cursor-pointer items-center gap-2.5">
              ...
              />
              <span className="text-[1.1rem] font-medium text-slate-600">
            ...
            <button
              type="submit"
              className="mt-1 flex h-14 w-full items-center justify-center gap-2 rounded-xl bg-[#174abf] text-[1.35rem] font-bold text-white shadow-[0_10px_18px_rgba(23,74,191,0.35)] transition hover:bg-[#123ea3]"
            >
              <span>Sign In</span>
              <ArrowRightIcon />
            </button>
